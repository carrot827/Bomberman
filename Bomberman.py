...
class Music :
    ...
    @staticmethod
    def music_start():
        os.startfile(r"Music\start.wav")

    @staticmethod
    def music_menu():
        os.startfile(r"Music\menu.wav")
        
    @staticmethod
    def music_battle():
        os.startfile(r"Music\battle.wav")
        
    @staticmethod
    def music_regle():
        os.startfile(r"Music\regles.wav")

    @staticmethod
    def music_draw():
        os.startfile(r"Music\draw.wav")

    @staticmethod
    def music_winner():
        os.startfile(r"Music\winner.wav")

    @staticmethod
    def sound_drug():
        os.startfile(r"Music\drug.wav")
